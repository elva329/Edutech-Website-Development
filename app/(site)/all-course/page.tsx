          ...
          <div className="grid grid-cols-2">
            ...
            <div>
              <h2 className="relative mb-6 text-4xl font-bold xl:text-hero text-[#3b065f]">
                Choose From Top Courses By
                <span className='bg-gradient-to-r from-purple-600 via-red-500 to-indigo-400 text-transparent bg-clip-text'> LearnNex </span>
